<html>
<head>
    <title>{{env('PAGE_TITLE', 'Watermark monitoring')}}</title>
    <link rel="icon" href="/images/waterDrop.png">
    ...
    <script language="javascript" type="text/javascript" src="/js/HourlyAverage/HourlyAverageController.js"></script>
